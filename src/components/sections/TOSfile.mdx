...
## 2. Request review ![search-compro](../../assets/icons/tos/search.png)
...
> Emphasis on "rough", the sketch will not reflect the final result. This acts as an overview of the request; poses, composition, wireframes.
...
### 1. Patience
Putting yourself in the inquiry means you agree to be patient until the request is done. I am a relatively slow artist *(atrociously slow even)*. Depending on how complex your request is, naturally it may take longer.  
*I will try my best to keep you up to date as frequently as possible.*
> **Important to mention:**  
> - If I haven't given you ANY updates in a span of **more than 2 weeks** (I might be cooked), do poke me about!  
> - And if things aren't going as planned or otherwise necessary, we can discuss whether I should do a [refund](#5-refunds) or consider other options.

> **⚠️ Update:**  
> I currently have a full time J*b, return times will take **much** longer than it used to.  
> ###### Still, that won't stop me from keeping you updated.
...
- "Hardcore genres" (extreme fetishes, etc.)
  > This includes "hyper" or "oversize".  
...
- On the payment process, you'll have up to **7 days** to complete the transaction - Otherwise your request will get skipped for another turn.
- By sheer chance, if you're a local **Indonesian**, do let me know as we could use alternative processors.  
  <span style="color: var(--foreSecondary)">(Kalo anda bener kebetulan sebuah **mahluk +62**, langsung bilang aja, kita bisa pake processor alternatif.)</span> 
  > First of all, my condolences.  
  > And exchange rate, naturally, still applies
...
### Q :: Can you do **anthros** in the `sketchbook` commission?
For the moment, not yet. Future, sure but I haven't come up with a price-set for it yet. Sorry!


### Q :: Did you vibe code all of this?
Mostly used for translation from vanilla html-css-js towards Astro framework, the rest of the legacy code, design and UX is written and planned ahead, the only difference now is that it used to be shite.  
Because who would've guessed maintaining a static vanilla html is not sustainable.  
  
This website has been in development since 2018, well before my chud ass knows anything about bundlers and frameworks let alone the ai boom. Well, until I do.  
  
If you're curious of how the old one looks, have a look [Here](https://potato22.github.io/commission-old/). It was charming ngl.
