...
The moment you sent your inquiry, I should be able to see your references and your request. From there I'll "**evaulate**" whether I can work with it, of course, I'll of course let you know either way
...
### 1. Patience
Putting yourself in the inquiry means you agree to keep your patience until I'm finished with your request. I am a relatively slow artist (probably atrociously slow even). This would be further amplified if your order is relatively complex and or featured with all sorts of backgrounds
...
- On the payment process, you'll have up to **7 days** to complete the transaction - Otherwise your request may get discarded.
...
> **Tip:** Try to make sure you're happy and **final** with your request if you can, as adding things in the middle that requires additional charges, and since the sum is likely very small: it **may get hit with significant transfer fee**. It's never recommended to send small amounts in almost any payment services.
...
> Unless I explicitly otherwise.

### 8. Simply: common-sense
Be polite while interacting with me! And take it easy, I'm not that grumpy - so no need to make your messages looking like the emails I see at 3 am. This TOS is long and elaborate simply in an attempt to make things as clear as possible. And therefore *should* mention everything that needs to be said.
...
### Q :: Can you draw `${else}` ?
Other than the one I mentioned that I will not draw, if you're still unsure, feel free to ask!
